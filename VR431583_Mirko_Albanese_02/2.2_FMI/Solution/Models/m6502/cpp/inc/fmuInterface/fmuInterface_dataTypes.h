...
#define MODEL_GUID "ec4f2124-ec56-4d84-b5b0-ef1fa3e193c0"
...
struct ModelInstance{
    ...
    ModelInstance( m6502 * model_0, m6502::m6502_iostruct * iostruct_0, char * instanceName_0,
         const int32_t cycle_number_0, const fmi2Real time_0, fmi2CallbackFunctions
         * functions_0, const fmi2Boolean logEvents_0, const fmi2Boolean logSingularLinearSystems_0,
         const fmi2Boolean logNonlinearSystems_0, const fmi2Boolean logDynamicStateSelection_0,
         const fmi2Boolean logStatusWarning_0, const fmi2Boolean logStatusDiscard_0,
         const fmi2Boolean logStatusError_0, const fmi2Boolean logStatusFatal_0,
         const fmi2Boolean logStatusPending_0, const fmi2Boolean logAll_0 ):
        model(model_0),
        iostruct(iostruct_0),

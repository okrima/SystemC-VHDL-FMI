...
#define MODEL_GUID "7aba5d78-d02d-40cb-8193-3671e452b9ad"
...
struct ModelInstance{
    memory * model;
    memory::memory_iostruct * iostruct;
    char * instanceName;
    ...
    ModelInstance( memory * model_0, memory::memory_iostruct * iostruct_0, char
         * instanceName_0, const int32_t cycle_number_0, const fmi2Real time_0,
         fmi2CallbackFunctions * functions_0, const fmi2Boolean logEvents_0, const
         fmi2Boolean logSingularLinearSystems_0, const fmi2Boolean logNonlinearSystems_0,
         const fmi2Boolean logDynamicStateSelection_0, const fmi2Boolean logStatusWarning_0,
         const fmi2Boolean logStatusDiscard_0, const fmi2Boolean logStatusError_0,
         const fmi2Boolean logStatusFatal_0, const fmi2Boolean logStatusPending_0,
         const fmi2Boolean logAll_0 ):
        model(model_0),
        iostruct(iostruct_0),

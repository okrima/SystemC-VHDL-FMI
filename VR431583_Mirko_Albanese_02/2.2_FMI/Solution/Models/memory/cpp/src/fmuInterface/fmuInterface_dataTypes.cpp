     ...
     fmi2Boolean visible, fmi2Boolean loggingOn )
{
    ...
    comp->model = reinterpret_cast< memory * >( functions->allocateMemory( static_cast<
    ...
    comp->iostruct = reinterpret_cast< memory::memory_iostruct * >( functions->allocateMemory
    ...
    new (comp->model) memory();
    new (comp->iostruct) memory::memory_iostruct();
...
{
    ModelInstance * comp = reinterpret_cast< ModelInstance * >( c );
    memory * model = nullptr;
    memory::memory_iostruct * iostruct = nullptr;
    if (comp == nullptr)
    {
        return;
    }
...
{
    ModelInstance * comp = reinterpret_cast< ModelInstance * >( c );
    memory::memory_iostruct * iostruct = comp->iostruct;
    size_t i = 0L;
    bool isError = false;
    ...
    for (i = 0L; i < nvr; i = i + 1L)
    {
        switch (static_cast< int32_t >( vr[i] ))
        {
            ...
            case int32_t(2L):
                ...
                break;
            case int32_t(3L):
                value[i] = static_cast< fmi2Integer >( iostruct->accelerometer 
                    );
                break;
            case int32_t(4L):
                value[i] = static_cast< fmi2Integer >( iostruct->data );
                break;
            case int32_t(5L):
                value[i] = static_cast< fmi2Integer >( iostruct->result );
                break;
            default:
                break;
        };
    ...
    for (i = 0L; i < nvr; i = i + 1L)
    {
        switch (static_cast< int32_t >( vr[i] ))
        {
            case int32_t(0L):
                ...
                break;
            case int32_t(1L):
                value[i] = iostruct->rst ? fmi2True : fmi2False;
                break;
            case int32_t(2L):
            ...
            case int32_t(10L):
                ...
                break;
            case int32_t(11L):
                value[i] = iostruct->data_rdy ? fmi2True : fmi2False;
                break;
            case int32_t(12L):
                value[i] = iostruct->result_rdy ? fmi2True : fmi2False;
                break;
            default:
                break;
        };
    ...
    for (i = 0L; i < nvr; i = i + 1L)
    {
        switch (static_cast< int32_t >( vr[i] ))
        {
            ...
            case int32_t(2L):
                ...
                break;
            case int32_t(3L):
                iostruct->accelerometer = value[i];
                break;
            case int32_t(4L):
                iostruct->data = value[i];
                break;
            case int32_t(5L):
                iostruct->result = value[i];
                break;
            default:
                break;
        };
    ...
    for (i = 0L; i < nvr; i = i + 1L)
    {
        switch (static_cast< int32_t >( vr[i] ))
        {
            ...
            case int32_t(10L):
                ...
                break;
            case int32_t(11L):
                iostruct->data_rdy = value[i] == fmi2True;
                break;
            case int32_t(12L):
                iostruct->result_rdy = value[i] == fmi2True;
                break;
            default:
                break;
        };
